...
void Contact::ResolveCollision()
{
	...
	// Proceed to calculate the collision impulse along the normal
	...
	// Proceed to calculate the collision impulse along the tangent
	...
	// Apply the tangent impulse vector to both objects in opposite direction
	a->ApplyImpulse(j, ra);
	b->ApplyImpulse(-j, rb);
}
